...
const OrganizationalGiftPack = () => {
  ...
  useEffect(() => {
    const getCollection = async () => {
      try {
        const response = await axios.get(`${API_URL}api/store/collections/11`);
    ...
    getCollection();
    document.title =
      "خرید پک هدیه سازمانی صنایع دستی | پک خاص شرکتی - کیمیا ترنج";
    ...
    canonical.href =
      "https://kimiatoranj.com/category/organizational-gift-pack";
  }, []);
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            ...
            کاری خود اهمیت می‌دهند. در این دسته‌بندی می‌توانید انواع پک‌های
            متنوع صنایع‌دستی شامل محصولات برنجی، قلمزنی، چای‌خوری، آجیل‌خوری،
            شمعدان و دیگر آثار فاخر هنری را مشاهده و انتخاب نمایید.
          </p>
        </div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.productTypesGrid}>
            ...
            <div className={styles.productTypeCard}>
              ...
              <p>
                تلفیقی از چند محصول هنری همچون ترمه، جاقاشقی، نمکدان، یا محصولات
